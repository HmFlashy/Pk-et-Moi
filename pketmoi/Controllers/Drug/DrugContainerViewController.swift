//
//  DrugContainerViewController.swift
//  pketmoi
//
...
class DrugContainerViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == segueIdentifier{
            ...
            if segue.identifier == "NotRegular"{
                ...
                let notRegularVC = vc as! ScheduleDrugNotRegularViewController
                notRegularVC.typeDrug = self.typeDrug
            }
            else{ //Regular
                vc = segue.destination
                let regularVC = vc as! ScheduleDrugRegularViewController
                regularVC.typeDrug = self.typeDrug
            }
